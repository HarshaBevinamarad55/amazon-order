// Sample order data
const orders = [
    { id: 1011, customer: "Indrakumar", status: "Pending", items: ["Laptop", "Phone"] },
    { id: 2022, customer: "Veeresh Sheeri", status: "Shipped", items: ["Tablet", "Headphones"] },
    { id: 3033, customer: "Tavisali M D", status: "Delivered", items: ["Camera", "Tripod"] },
  ];
